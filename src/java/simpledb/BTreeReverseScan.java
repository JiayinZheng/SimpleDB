...
/**
 * BTreeScan is an operator which reads tuples in reversely sorted order
...
public class BTreeReverseScan implements OpIterator {
     ...
     *            in sorted order
     */
    public BTreeReverseScan(TransactionId tid, int tableid, String tableAlias, IndexPredicate ipred) throws TransactionAbortedException, DbException {
        this.tid = tid;
        this.ipred = ipred;
    ...
    public void reset(int tableid, String tableAlias) throws TransactionAbortedException, DbException {
        ...
        if(ipred == null) {
            ...
            this.it = bTreeFile.indexReverseIterator(tid,ipred);
        }
        else {
    ...
    public BTreeReverseScan(TransactionId tid, int tableid, IndexPredicate ipred) throws TransactionAbortedException, DbException {
